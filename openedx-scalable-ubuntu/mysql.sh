...
echo "Assigning mysql user root + migrate + EDXAPP + XQUEUE access on %."
...
sudo mysql --execute "GRANT ALL PRIVILEGES ON *.* TO xqueue001@'%' IDENTIFIED BY 'XQUEUEPASS'; FLUSH PRIVILEGES;"
